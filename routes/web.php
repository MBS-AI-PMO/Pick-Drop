...
// PickDrop Admin Routes
Route::get('/users', function () { return view('pickdrop.users.index'); });
Route::get('/vehicles', function () { return view('pickdrop.vehicles.index'); });
Route::get('/routes', function () { return view('pickdrop.routes.index'); });
Route::get('/routes/create', function () { return view('pickdrop.routes.create'); });
Route::get('/routes/{id}/edit', function ($id) { return view('pickdrop.routes.edit'); });
Route::get('/payments', function () { return view('pickdrop.payments.index'); });
Route::get('/reports', function () { return view('pickdrop.reports.index'); });
