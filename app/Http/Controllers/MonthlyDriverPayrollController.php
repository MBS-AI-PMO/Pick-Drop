...
use App\Services\MonthlyDriverPayrollService;
use Illuminate\Http\Request;
use Illuminate\Support\Carbon;
use RuntimeException;

class MonthlyDriverPayrollController extends Controller
{
    public function index(Request $request, MonthlyDriverPayrollService $payrolls)
    {
    ...
    public function recalculate(Request $request, MonthlyDriverPayrollService $payrolls)
    {
        $month = $this->month($request);
    ...
    public function show(DriverPayroll $payroll, MonthlyDriverPayrollService $payrolls)
    {
    ...
    public function markDay(
        ...
        MonthlyDriverPayrollService $payrolls
    ) {
        if ($payroll->isLocked()) {
    ...
    public function approve(Request $request, DriverPayroll $payroll, MonthlyDriverPayrollService $payrolls)
    {
        $payrolls->generate($payroll->month, $payroll->driver_id);
    ...
    public function pay(Request $request, DriverPayroll $payroll, MonthlyDriverPayrollService $payrolls)
    {
        $payrolls->generate($payroll->month, $payroll->driver_id);
