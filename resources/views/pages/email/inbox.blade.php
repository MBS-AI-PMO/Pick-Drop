          ...
          <div class="col-lg-9 col-xxl-10">
              ...
              <div class="row align-items-center">
                <div class="col-lg-6">
                  <div class="d-flex align-items-end mb-2 mb-lg-0">
                    <i data-lucide="inbox" class="text-secondary me-2"></i>
                ...
                <div class="col-lg-6">
                  <div class="input-group">
                    ...
                    <button class="btn btn-icon border bg-transparent" type="button" id="button-search-addon"><i data-lucide="search"></i></button>
                  </div>
                </div>
              </div>
            </div>
            <div class="p-3 border-bottom d-flex align-items-center justify-content-between flex-wrap">
              ...
              <div class="d-flex align-items-center justify-content-end flex-grow-1">
                ...
                <div class="btn-group">
                  <button class="btn btn-outline-secondary btn-icon" type="button"><i data-lucide="chevron-left"></i></button>
                  <button class="btn btn-outline-secondary btn-icon" type="button"><i data-lucide="chevron-right"></i></button>
                </div>
              </div>
            </div>
            <div class="email-list">
              ...
              <div class="email-list-item email-list-item--unread">
                <div class="email-list-actions">
                  ...
                  <a class="favorite" href="javascript:;"><span><i data-lucide="star"></i></span></a>
                </div>
                <a href="{{ route('email.read') }}" class="email-list-detail">
                  <div class="content">
                    <span class="from">Cedric Kelly</span>
                    <p class="msg">Urgent - You forgot your keys in the class room, please come imediatly! Urgent - You forgot your keys in the class room, please come imediatly! Urgent - You ot your keys in the class room, please come imediatly! Urgent - You forgot your keys in the class room, please come imediatly! Urgent - You forgot your keys in the class room, please come imediatly!</p>
                  </div>
                  <span class="date">
                    08 Jan
                  </span>
              ...
              <div class="email-list-item">
                <div class="email-list-actions">
                  ...
                  <a class="favorite" href="#"><span><i data-lucide="star" class="text-warning"></i></span></a>
                </div>
                <a href="{{ route('email.read') }}" class="email-list-detail">
                  <div class="content">
