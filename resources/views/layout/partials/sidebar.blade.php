<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav" id="sidebarNav">
      ...
      <li class="pd-nav-section">
        <span class="pd-nav-section-label">Overview</span>
      ...
      <li class="pd-nav-section">
        <span class="pd-nav-section-label">People</span>
        <ul class="pd-nav-section-list">
      ...
      <li class="pd-nav-section">
        <span class="pd-nav-section-label">Operations</span>
        <ul class="pd-nav-section-list">
      ...
      <li class="pd-nav-section">
        <span class="pd-nav-section-label">Support</span>
        <ul class="pd-nav-section-list">
      ...
      <li class="pd-nav-section">
        <span class="pd-nav-section-label">Finance</span>
        <ul class="pd-nav-section-list">
  ...
  <div class="sidebar-footer">
    <ul class="nav pd-nav-section-list">
